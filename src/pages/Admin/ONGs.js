        ...
        {showPasswordModal && (
          <div style={{
            ...
            <div style={{
              ...
              <h2 style={{ marginBottom: '16px', fontSize: '20px', color: 'var(--primary-green)' }}>✅ ONG Criada com Sucesso!</h2>
              <p style={{ marginBottom: '20px', color: 'var(--gray)' }}>
                A ONG foi cadastrada com sucesso! Anote a senha abaixo e repasse para a organização:
              </p>
              <div style={{
                ...
                <div style={{ fontSize: '14px', opacity: '0.9', marginBottom: '8px' }}>🔑 Senha de Acesso</div>
              ...
              <div style={{
                ...
                ⚠️ <strong>Importante:</strong> Anote esta senha agora! Ela não será exibida novamente.
              </div>
              <div style={{ display: 'flex', gap: '12px' }}>
                <button 
